...
<p align="center">
  Shareable markdownlint configuration rules adhering to 2026 standards
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/markdownlint-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fmarkdownlint-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/markdownlint-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14512"><img src="https://img.shields.io/cii/level/14512?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Markdown Structure & Style Rules](#markdown-structure--style-rules) — before and after rule comparison
...
Install `@sebastienrousseau/markdownlint-config` as a development dependency:
...
markdownlint reads `.markdownlint.json`, or a JS config that requires this package.
...
`@sebastienrousseau/markdownlint-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/markdownlint-config` solves this with three deliberate engineering choices:
...
When authoring documents that deliberately violate standard GFM rules (such as raw HTML tables with unescaped pipes or unindented code blocks).
