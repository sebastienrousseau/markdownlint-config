...
# Packaging @sebastienrousseau/markdownlint-config
...
Peer dependency: `markdownlint >=0.25.0`.
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/markdownlint-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/markdownlint-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/markdownlint-config/` |
| Homebrew | [`pkg/brew/markdownlint-config.rb`](../pkg/brew/markdownlint-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/markdownlint-config/` |
