...
%global npm_bare      markdownlint-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-markdownlint-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable markdownlint configuration rules adhering to 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/markdownlint-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/markdownlint-config is a shareable configuration preset with no runtime
