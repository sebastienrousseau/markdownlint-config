...
This document describes how @sebastienrousseau/markdownlint-config is run: who decides what, how
...
@sebastienrousseau/markdownlint-config is **maintainer-led**. As of the current release line it has a single
